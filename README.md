...
7. Также для будущих манипуляций с аккаунтом, стоит сразу добавить два шаблона c путями url -> templates/accounts/password/reset/ и -> templates/accounts/password/change/. Подробнее по ссылке - https://russianblogs.com/article/6833594772/
8. Для отправки писем нужно использовать SMTP сервис, например smtp.bz. Гуглить.
-----------------------------------------------------------------
ЧАСТЬ 9 - 
-----------------------------------------------------------------
