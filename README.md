...
6. В js файле пропишем интерактив. Звездочки готовы. В будущем надо добавить вместо ip зарегистрированого пользователя и сохранения рейтинга при перезагрузке.
-----------------------------------------------------------------
ЧАСТЬ 24 - 
-----------------------------------------------------------------
